...
const translations = {
  ...
  ro: {
    ...
    "home.subtitle":
      "Fă testul de interese RIASEC, validat științific pentru a descoperi cariere care se aliniază cu interesele si dorintele tale. Primește recomandări personalizate pentru joburi din prezent și din viitorul apropiat.",
    "home.cta.primary": "Începe evaluarea",
    ...
    "home.features.validated.desc":
      "Bazat pe modelul RIASEC dovedit, folosit de consilierii de carieră din întreaga lume pentru a ghida persoanele spre carierele cele mai potrivite.",
    "home.features.future.title": "Perspective de viitor",
    "home.features.future.desc":
      "Primește recomandări pentru cariere din prezent și roluri emergente, incluzând analiza impactului AI și evaluarea riscului de automatizare.",
    ...
    "home.howItWorks.step3.title": "Explorează ccăile de carieră propuse",
    "home.howItWorks.step3.desc":
      "Descoperă locuri de muncă din prezent si din viitorul apropiat care se aliniază cu interesele tale.",
    ...
    "dashboard.assessment.topType": "Tipul principal de interes vocațional:",
    ...
    // Pricing
    "pricing.title": "Alege planul de explorare a carierei",
    "pricing.subtitle":
    ...
    "pricing.features.assessment": "Evaluare completă de interese RIASEC",
    "pricing.features.profile": "Profil de bază de interese vocaționale cu top 3 tipuri",
    "pricing.features.traditional": "6 recomandări de profesii din prezent",
    "pricing.features.future": "6 recomandări de profesii viitoare",
